    ...
    <>
      <div className="row" style={{ background: '#0b2c3d', margin: '0' }}>
          <ul className="top-info center">
            ...
            <li><a target="_blank" href="https://www.facebook.com/tudosobreap?locale=pt_BR"><FacebookIcon className="icon icon-face"/></a></li>
            <li><a target="_blank" href="https://www.instagram.com/tudosobreap/"><InstagramIcon className="icon icon-insta"/></a></li>
          </ul>
      </div>
    </>
  );
